...
INSERT IGNORE INTO `fb_identities` (`identity_id`, `account_id`, `identity_uid`, `identity_status`, `created_at`, `updated_at`, `identity_type`, `identity_token`, `params`) VALUES
    ...
    (_binary 0x540F6CFC39D1417587FBAAC729D78C0A, _binary 0xFF32AC4EF0104C859CB3D310F6708A4E, 'deviceUsername', 'active', '2017-05-03 11:27:34', '2019-05-29 07:14:00', 'machine', 'unsecuredDevicePassword', '[]');

INSERT IGNORE INTO `fb_security_tokens` (`token_id`, `parent_id`, `token_token`, `token_status`, `token_type`) VALUES
    (_binary 0x4F6710A138AA42649C0CB45285181270, NULL, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI5YWY1NjI0Mi01ZDg3LTQzNjQtYmIxZS1kOWZjODI4NmIzZmYiLCJpc3MiOiJjb20uZmFzdHliaXJkLmF1dGgtbm9kZSIsImlhdCI6MTU4NTc0MjQwMCwiZXhwIjoxNTg1NzQ5NjAwLCJ1c2VyIjoiNWU3OWVmYmYtYmQwZC01YjdjLTQ2ZWYtYmZiZGVmYmZiZDM0Iiwicm9sZXMiOlsiYWRtaW5pc3RyYXRvciJdfQ.Lb-zUa9DL7swdVSEuPTqaR9FvLgKwuEtrhxiJFWjhU8', 'active', 'accessToken'),
    ...
    (_binary 0x956A7E26E8C04BDB894ADD21B14E4A94, NULL, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI3YzVkNzdhZC1kOTNlLTRjMmMtOThlNS05ZTFhZmM0NDQ2MTUiLCJpc3MiOiJjb20uZmFzdHliaXJkLmF1dGgtbm9kZSIsImlhdCI6MTU4NTc0MjQwMCwiZXhwIjoxNTg1NzQ5NjAwLCJ1c2VyIjoiZWZiZmJkZWYtYmZiZC02OGVmLWJmYmQtNzcwYjQwZWZiZmJkIiwicm9sZXMiOlsidXNlciJdfQ.cbatWCuGX-K8XbF9MMN7DqxV9hriWmUSGcDGGmnxXX0', 'active', 'accessToken'),
...
INSERT IGNORE INTO `fb_security_tokens_access` (`token_id`, `identity_id`, `token_valid_till`, `params`, `created_at`, `updated_at`) VALUES
    (_binary 0x4F6710A138AA42649C0CB45285181270, _binary 0x77331268EFBFBD3449EFBFBDEFBFBD04, '2020-04-01 18:00:00', '[]', '2020-06-23 19:32:18', '2020-06-23 19:32:18'),
...
INSERT IGNORE INTO `fb_security_tokens_refresh` (`token_id`, `token_valid_till`, `params`, `created_at`, `updated_at`) VALUES
    (_binary 0x35BE56240160432383EE6F59000934B4, '2020-04-04 12:00:00', '[]', '2020-06-23 19:32:18', '2020-06-23 19:32:18'),
...
INSERT IGNORE INTO `fb_vernemq_acl` (`id`, `account_id`, `mountpoint`, `client_id`, `username`, `password`, `publish_acl`, `subscribe_acl`) VALUES
    (_binary 0x5E79EFBFBD0D5B7C46EFBFBDEFBFBD34, _binary 0xFF32AC4EF0104C859CB3D310F6708A4E, '', '', 'jane.doe@fastybird.com', 'passwd', '[]', '[]');
