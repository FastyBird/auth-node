...
VALUES (_binary 0xBF4CD8702AAC45F0A85EE1CEFD2D6D9A, 'machine', 'active', '2019-11-07 22:30:56', '[]',
        '2017-01-03 11:30:00', '2017-01-03 11:30:00');

INSERT IGNORE INTO `fb_accounts_machines` (`account_device`, `account_id`, `owner_id`)
VALUES ('machine-second-device-name', _binary 0xBF4CD8702AAC45F0A85EE1CEFD2D6D9A, _binary 0xEFBFBDEFBFBD68EFBFBD770B40EFBFBD);
