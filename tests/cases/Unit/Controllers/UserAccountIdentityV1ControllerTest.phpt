...
final class UserAccountIdentityV1ControllerTest extends DbTestCase
{
	 ...
	 *
	 * @dataProvider ./../../../fixtures/Controllers/userAccountIdentityUpdate.php
	 */
	 ...
	 * @param string $fixture
	 *
	 * @dataProvider ./../../../fixtures/Controllers/userAccountIdentityValidate.php
	 */
	 ...
	 * @param string $fixture
	 *
	 * @dataProvider ./../../../fixtures/Controllers/userAccountIdentityRequestPassword.php
	 */
...
$test_case = new UserAccountIdentityV1ControllerTest();
$test_case->run();
