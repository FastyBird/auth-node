...
return [
	'create' => [
		'/v1/accounts/efbfbdef-bfbd-68ef-bfbd-770b40efbfbd/security-question',
		...
		file_get_contents(__DIR__ . '/requests/securityQuestion.create.json'),
		StatusCodeInterface::STATUS_CREATED,
		__DIR__ . '/responses/securityQuestion.create.json',
	],
	'missingRequired' => [
		'/v1/accounts/efbfbdef-bfbd-68ef-bfbd-770b40efbfbd/security-question',
		'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1NjU5NDI5ODAsImV4cCI6MTU2NTk2NDU4MCwianRpIjoiNjg4NTE4ZTktMGE2Ni00ZGVmLTg1ODItMWY5YzNjOGI1NGE4In0.ry-j4RnM9j1HrV6ktI_ATXVibV7FSe3yq52vN7e83jk',
		file_get_contents(__DIR__ . '/requests/securityQuestion.create.missing.required.json'),
		StatusCodeInterface::STATUS_UNPROCESSABLE_ENTITY,
		__DIR__ . '/responses/securityQuestion.create.missingRequired.json',
	],
	'invalidType' => [
		'/v1/accounts/efbfbdef-bfbd-68ef-bfbd-770b40efbfbd/security-question',
		'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1NjU5NDI5ODAsImV4cCI6MTU2NTk2NDU4MCwianRpIjoiNjg4NTE4ZTktMGE2Ni00ZGVmLTg1ODItMWY5YzNjOGI1NGE4In0.ry-j4RnM9j1HrV6ktI_ATXVibV7FSe3yq52vN7e83jk',
		file_get_contents(__DIR__ . '/requests/securityQuestion.create.invalidType.json'),
		StatusCodeInterface::STATUS_UNPROCESSABLE_ENTITY,
		__DIR__ . '/responses/securityQuestion.invalidType.json',
	],
	'unauthorized' => [
		'/v1/accounts/5e79efbf-bd0d-5b7c-46ef-bfbdefbfbd34/security-question',
	...
	'existingQuestion' => [
		...
		file_get_contents(__DIR__ . '/requests/securityQuestion.create.existingQuestion.json'),
		StatusCodeInterface::STATUS_BAD_REQUEST,
		__DIR__ . '/responses/securityQuestion.create.existingQuestion.json',
	],
];
