...
return [
	...
	'readAllPaging'            => [
		'/v1/emails?page[offset]=1&page[limit]=1',
		'Bearer ' . ADMINISTRATOR_TOKEN,
		StatusCodeInterface::STATUS_OK,
	...
	'readRelationshipsAccount' => [
		'/v1/emails/' . ADMINISTRATOR_EMAIL_ID . '/relationships/' . Schemas\Emails\EmailSchema::RELATIONSHIPS_ACCOUNT,
		'Bearer ' . ADMINISTRATOR_TOKEN,
		StatusCodeInterface::STATUS_OK,
	...
	'readRelationshipsUnknown' => [
		'/v1/emails/' . ADMINISTRATOR_EMAIL_ID . '/relationships/unknown',
		'Bearer ' . ADMINISTRATOR_TOKEN,
		StatusCodeInterface::STATUS_NOT_FOUND,
