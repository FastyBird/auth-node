...
return [
	'read'                     => [
		...
		__DIR__ . '/responses/account.securityQuestion.read.json',
	],
	'readRelationshipsAccount' => [
		'/v1/me/security-question/relationships/account',
		'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1NzU5MzIxMTgsImV4cCI6MTU3NTk1MzcxOCwianRpIjoiYWI5Y2MwNjktM2QzZS00Mzk3LWFmYjItNjY2ZDIyOTFlZWUwIn0.G507WDqVFp_mIaHE8eyg1LEywTDV1OGgWtYgFwoyCQg',
		StatusCodeInterface::STATUS_OK,
		__DIR__ . '/responses/account.securityQuestion.readRelationships.account.json',
	],
	'readRelationshipsUnknown' => [
		'/v1/me/security-question/relationships/unknown',
		'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1NzU5MzIxMTgsImV4cCI6MTU3NTk1MzcxOCwianRpIjoiYWI5Y2MwNjktM2QzZS00Mzk3LWFmYjItNjY2ZDIyOTFlZWUwIn0.G507WDqVFp_mIaHE8eyg1LEywTDV1OGgWtYgFwoyCQg',
	...
	'noQuestion'               => [
		...
		StatusCodeInterface::STATUS_NOT_FOUND,
		__DIR__ . '/responses/account.securityQuestion.noQuestion.json',
	],
];
