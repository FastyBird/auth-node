 ...
 * @author          Adam Kadlec <adam.kadlec@fastybird.com>
 *
 * @phpstan-extends NodeJsonApiSchemas\JsonApiSchema<Entities\Identities\UserAccountIdentity>
 */
final class UserAccountIdentitySchema extends NodeJsonApiSchemas\JsonApiSchema
{
	...
	/**
	 * @param Entities\Identities\UserAccountIdentity $identity
